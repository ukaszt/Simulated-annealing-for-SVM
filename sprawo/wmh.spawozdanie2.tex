...
\paragraph{}
Poniższy wykres prezentuje ilość błędów w zależności od dobranych parametrów przy użyciu metody pełnego przeglądu.
\pgfplotsset{width=16cm,compat=1.4}
\begin{center}
\begin{tikzpicture}
\begin{axis}
